    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Section style={card}>
          ...
          <Text style={text}>
            Vous avez été invité à rejoindre <Link href={siteUrl} style={link}><strong>{siteName}</strong></Link>.
            Acceptez l'invitation pour créer votre compte et entrer en jeu.
          </Text>
          <Section style={{ textAlign: 'center', margin: '32px 0' }}>
            <Button style={button} href={confirmationUrl}>Accepter l'invitation</Button>
          </Section>
          <Text style={footer}>Si cette invitation n'était pas pour vous, ignorez ce message.</Text>
        </Section>
