...
const CharacterSheet = ({ character, onEdit, onClose }: CharacterSheetProps) => {
  ...
  const equippedWeapon: MagicItem | null = null;
  const equippedArmor: MagicItem | null = null;
  const knownSpellIds: string[] = (character.known_spells as string[]) || [];
  const preparedSpellIds: string[] = (character.prepared_spells as string[]) || [];
