...
export const CLASSES: AetheriaClass[] = [
  ...
  },
  {
    ...
    emoji: "🩸",
    tier: "core",
    tagline: "Rage. Dégâts massifs. Encaissement agressif.",
    description: "Le vrai barbare d'Aetheria. Moins technique que le Guerrier, plus brutal.",
    identity: "Encaisser pour mieux frapper. La douleur devient du carburant.",
    primaryStat: "Force",
    secondaryStat: "Endurance",
    hpDie: "1d10",
    hpMinimum: 6,
    armor: "intermediaire",
    playstyle: ["Rage", "Dégâts massifs", "Encaissement", "Brutalité"],
    baseAbility: {
      id: "rage-berserker",
      name: "Rage",
      type: "active",
      peCost: 2,
      effect: "Entre en Rage 3 tours : +2 dégâts, -1 DEF PHY. Encaissements donnent +2 offensif.",
      levels: [
        { level: 3, bonus: "+3 dégâts en Rage" },
        { level: 5, bonus: "Durée 4 tours, +1 PV par encaissement" },
        { level: 7, bonus: "DEF PHY ne diminue plus en Rage" },
      ],
    },
    outfits: [],
  },
  {
    ...
    emoji: "🛠️",
    tier: "advanced",
    tagline: "Support tactique. Runes, buffs temporaires, contrôle.",
    description: "Artisan combattant. Modifie le combat plutôt que de l'affronter.",
    identity: "Le combat se gagne avant qu'il commence. Tes runes décident.",
    primaryStat: "Esprit",
    secondaryStat: "Endurance",
    hpDie: "1d8",
    hpMinimum: 4,
    armor: "intermediaire",
    playstyle: ["Support", "Contrôle", "Buffs temporaires", "Pièges"],
    baseAbility: {
      id: "gravure-rune",
      name: "Gravure de Rune",
      type: "active",
      peCost: 1,
      effect: "Grave une rune sur arme/armure alliée. Durée 3 tours.",
      levels: [
        { level: 3, bonus: "Durée 4 tours" },
        { level: 5, bonus: "Peut graver 2 runes simultanément" },
        { level: 7, bonus: "Durée 5 tours, effets renforcés" },
      ],
    },
    outfits: [],
  },
  {
    ...
    emoji: "🐾",
    tier: "advanced",
    tagline: "Combat instinctif lié aux esprits animaux.",
    description: "Il canalise les esprits bestiaux. Chaque esprit apporte un style unique.",
    identity: "L'instinct est ta meilleure arme.",
    primaryStat: "Force",
    secondaryStat: "Agilité",
    hpDie: "1d10",
    hpMinimum: 6,
    armor: "intermediaire",
    playstyle: ["Buffs bestiaux", "Adaptation", "Instincts", "Polyvalence"],
    baseAbility: {
      id: "appel-totem",
      name: "Appel du Totem",
      type: "active",
      peCost: 2,
      effect: "Invoque un esprit animal 3 tours. Loup: +1 attaque. Ours: +2 réduction. Fauve: +2 mouvement.",
      levels: [
        { level: 3, bonus: "Durée 4 tours" },
        { level: 5, bonus: "Bonus +1" },
        { level: 7, bonus: "Peut combiner deux totems" },
      ],
    },
    outfits: [],
  },
  {
    ...
    emoji: "🩸",
    tier: "advanced",
    tagline: "Magie du sang. Sacrifice. Malédictions.",
    description: "Puise dans sa propre vitalité pour alimenter sa magie.",
    identity: "Chaque sort te coûte quelque chose. Et chaque sacrifice renforce le suivant.",
    primaryStat: "Esprit",
    secondaryStat: "Endurance",
    hpDie: "1d8",
    hpMinimum: 4,
    armor: "legere",
    playstyle: ["Sacrifice PV", "Malédictions", "Soins inversés", "Pression"],
    baseAbility: {
      id: "offrande-sang",
      name: "Offrande de Sang",
      type: "active",
      effect: "Sacrifie 2 PV pour gagner 1 PE. Utilisable à tout moment.",
      levels: [
        { level: 3, bonus: "2 PV → 2 PE" },
        { level: 5, bonus: "1 PV → 1 PE" },
        { level: 7, bonus: "Peut sacrifier jusqu'à 6 PV en une fois" },
      ],
    },
    outfits: [],
  },
  {
    ...
    emoji: "🎯",
    tier: "advanced",
    tagline: "Archer, pisteur, précision et nature.",
    description: "Plus orienté nature que l'Artilleur. Il chasse, piège, élimine à distance.",
    identity: "La proie ne sait jamais d'où vient la flèche.",
    primaryStat: "Agilité",
    secondaryStat: "Esprit",
    hpDie: "1d8",
    hpMinimum: 4,
    armor: "legere",
    playstyle: ["Pièges", "Chasse", "Précision", "Terrain"],
    baseAbility: {
      id: "marque-proie",
      name: "Marque de Proie",
      type: "active",
      peCost: 1,
      effect: "+1 attaque et +1d4 dégâts contre la cible marquée pendant 3 tours.",
      levels: [
        { level: 3, bonus: "+2 attaque, +1d6 dégâts" },
        { level: 5, bonus: "La marque se transfère si la cible meurt" },
        { level: 7, bonus: "+3 attaque, +1d8 dégâts" },
      ],
    },
    outfits: [],
  },
  {
    ...
    emoji: "⚡",
    tier: "advanced",
    tagline: "Manipulation d'énergie pure. PE avancés. Surcharge.",
    description: "Plus mystique qu'un mage. Manipule l'énergie brute du monde.",
    identity: "L'énergie qui coule en toi est plus ancienne que la magie.",
    primaryStat: "Esprit",
    secondaryStat: "Agilité",
    hpDie: "1d8",
    hpMinimum: 4,
    armor: "legere",
    playstyle: ["PE avancés", "Amplification", "Surcharge contrôlée", "Mystique"],
    baseAbility: {
      id: "flux-energetique",
      name: "Flux Énergétique",
      type: "passive",
      effect: "Récupère +2 PE/tour au lieu de +1. Surcharges infligent 1d4-2 dégâts (min 0).",
      levels: [
        { level: 3, bonus: "+3 PE par tour" },
        { level: 5, bonus: "Surcharges sans dégâts 1x/combat" },
        { level: 7, bonus: "+4 PE par tour" },
      ],
    },
    outfits: [],
  },
