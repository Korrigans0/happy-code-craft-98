...
export const campaignsApi = {
  ...
  updateNote: (id: string, noteId: string, data: any) => request<any>("PATCH", `/campaigns/${id}/notes/${noteId}`, data),
  deleteNote: (id: string, noteId: string) => request<any>("DELETE", `/campaigns/${id}/notes/${noteId}`),
  getCampaignCharacters: (id: string) => request<any[]>("GET", `/campaigns/${id}/characters`),
